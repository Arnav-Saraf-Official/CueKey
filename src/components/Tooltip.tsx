...
const styles = tv({
  base: 'group bg-emerald-600 text-white/90 py-1 px-2 rounded-md text-sm drop-shadow-lg will-change-transform',
  variants: {
    isEntering: {
    ...
    >
      <OverlayArrow>
        <svg
          ...
          height={8}
          viewBox="0 0 8 8"
          className="group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90 fill-emerald-600"
        >
